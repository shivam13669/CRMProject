...
export const CustomerProvider: React.FC<CustomerProviderProps> = ({ children }) => {
  ...
  // Get authentication token from localStorage (same key as AuthContext)
  const getAuthToken = () => localStorage.getItem('healthcare_crm_token');
  ...
  // Load customers when a token exists
  useEffect(() => {
    const token = getAuthToken();
